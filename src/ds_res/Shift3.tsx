...
const renderColumns = ["P_S_3", "R_S_3", "O_S_3", "K_S_3"];

export default class Shift3 extends React.Component<any> {
  ...
  public render() {
    ...
    return <List data={data} title={"Смена 3"} subtitles={shiftsTitles} />;
  }
}
